...
# MAGIC MANAGED LOCATION "abfss://presentation@databrickscoursestgacc.dfs.core.windows.net/"

# COMMAND ----------

final_df.write.mode("overwrite").format("delta").saveAsTable("presentation.race_results")